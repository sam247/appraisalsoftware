...
export const metadata = pageMetadata({ title: "How Appraisal Software Works | Employee and Manager Reviews", description: "See how to create an appraisal campaign, assign employees and managers, collect responses and review Self vs Manager results in one focused workflow.", path: "/how-it-works" });
const steps = [
...
export default function Page() { return <SiteChrome>
  ...
  <ContentSection title="What the workflow includes"><p>Appraisal Software gives you reusable questions, campaign dates, employee and manager assignments, structured respondent forms, completion tracking, configured reminders and Self vs Manager results.</p><p>The product stays focused on appraisals rather than trying to replace payroll, absence, recruitment or a wider HR suite. For 360 planning, use the separate guides, questions, examples and template.</p></ContentSection>
